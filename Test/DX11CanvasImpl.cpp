...
graphics::dx11::renderer::DX11CanvasImpl::DX11CanvasImpl() {}
...
bool graphics::dx11::renderer::DX11CanvasImpl::createRenderTargetView()
{
...
bool graphics::dx11::renderer::DX11CanvasImpl::Initialize(void* windowHandle)
{
...
void graphics::dx11::renderer::DX11CanvasImpl::Resize(uint32_t width, uint32_t height)
{
    if (!swapChain)
        return;
...
void graphics::dx11::renderer::DX11CanvasImpl::ShutDown()
{
...
void graphics::dx11::renderer::DX11CanvasImpl::Begin()
{
    DX11Core& core = DX11Core::Instance();
...
void graphics::dx11::renderer::DX11CanvasImpl::End()
{
    if (!swapChain)
        return;
...
void graphics::dx11::renderer::DX11CanvasImpl::Clear(float red, float green, float blue, float alpha)
{
    DX11Core& core = DX11Core::Instance();
...
void graphics::dx11::renderer::DX11CanvasImpl::SetViewPort(float x, float y, float width, float height)
{
    DX11Core& core = DX11Core::Instance();
...
void graphics::dx11::renderer::DX11CanvasImpl::SetViewPort()
{
