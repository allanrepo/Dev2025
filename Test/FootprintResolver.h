		...
		struct Constraints
		{
				...
				const spatial::SizeF& tileSize)
			{
				...
				// if cannot fit, can bail out here quickly. no point resolving since we know it's guaranteed to fail.
				{
					...
					{
						bool isNextRightAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, NextRow, NextCol + 1);
						bool isNextLefttAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, NextRow, NextCol - 1);
					...
					{
						bool isNextBottomAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, NextRow + 1, NextCol);
						bool isNextTopAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, NextRow - 1, NextCol);
					...
					case navigation::tile::Direction::Up:
					{
						...
						// 1C0
						//  ^
						bool isCurrLeftAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, currRow, currCol - 1);
						bool isNextRightAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, NextRow, NextCol + 1);
						...
						// 0C1
						//  ^
						bool isCurrRightAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, currRow, currCol + 1);
						bool isNextLefttAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, NextRow, NextCol - 1);
						...
						// 100
						//  ^
						bool isCurrBottomLeftAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, currRow + 1, currCol - 1);
						...
						// 001
						//  ^
						bool isCurrBottomRightAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, currRow + 1, currCol + 1);
					...
					case navigation::tile::Direction::Down:
					{
						...
						// 0C0
						// 1N0
						bool isCurrTopRightAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, currRow - 1, currCol + 1);
						...
						// 0C0
						// 0N1
						bool isCurrTopLeftAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, currRow - 1, currCol - 1);
					...
					case navigation::tile::Direction::Right:
					{
						...
						//  01		
						bool isNextBottomAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, NextRow + 1, NextCol);
						bool isCurrTopAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, currRow - 1, currCol);
						...
						//  10		
						bool isNextTopAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, NextRow - 1, NextCol);
						bool isCurrBottomAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, currRow + 1, currCol);
					...
					case navigation::tile::Direction::Left:
					{
						...
						// NC0<
						// 100							
						bool isCurrTopRighttAdjTileWalkable = component::tile::IsWalkable(tilemap, tileset, currRow - 1, currCol + 1);
