...
{
	return cache::ContextCache<graphics::resource::ITexture>::Instance().CanBind(this, false);
}

void graphics::dx11::resource::DX11TextureImpl::Bind()
{
	cache::ContextCache<graphics::resource::ITexture>::Instance().Bind(
