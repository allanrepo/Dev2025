...
graphics::resource::FontAtlas::FontAtlas(std::unique_ptr<graphics::resource::ITexture> tex)
	: texture(std::move(tex))
{
}

void graphics::resource::FontAtlas::Reset() 
{
	texture->Reset();
	glyphs.clear();
}

bool graphics::resource::FontAtlas::Initialize(const std::string& fontName, const unsigned int fontSize) 
{
...
const text::Glyph* graphics::resource::FontAtlas::GetGlyph(const unsigned char character) const
{
...
bool graphics::resource::FontAtlas::GetNormalizedTexCoord(const unsigned char character, float& u0, float& v0, float& u1, float& v1) const 
{
	if (character < 32 || character > 127)
	{
...
math::geometry::RectF graphics::resource::FontAtlas::GetUVRect() const
{
	return math::geometry::RectF{ 0, 0, 1, 1 };
}

void graphics::resource::FontAtlas::Bind() const
{
	texture->Bind();
}

bool graphics::resource::FontAtlas::CanBind() const 
{
	return texture->CanBind();
}

const float graphics::resource::FontAtlas::GetWidth(const unsigned char character) const 
{
	if (character < 32 || character > 127)
	{
		LOGERROR("Invalid character specified in getting texture coordinates. Integer value must be between 33 to 127. Specified value is " << std::to_string(character));
...
const float graphics::resource::FontAtlas::GetHeight(const unsigned char character) const 
{
	if (character < 32 || character > 127)
	{
		LOGERROR("Invalid character specified in getting texture coordinates. Integer value must be between 33 to 127. Specified value is " << std::to_string(character));
...
const float graphics::resource::FontAtlas::GetWidth() const
{
	return static_cast<float>(texture->GetWidth());
}

const float graphics::resource::FontAtlas::GetHeight() const
{
	return static_cast<float>(texture->GetHeight());
}

const spatial::SizeF graphics::resource::FontAtlas::GetSize() const
{
