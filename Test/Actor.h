...
namespace component
{
	...
	private:
		std::string m_name;
		spatial::Transform m_transform;
		spatial::Motion m_motion;
		graphics::animation::Animator<graphics::resource::Sprite> m_animator;
		cache::Dictionary <std::string, std::unique_ptr<graphics::animation::Animation<graphics::resource::Sprite>>> m_animations;
		state::StateMachine<component::IActor> m_stateMachine;
